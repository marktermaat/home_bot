defmodule HomeWeb.GasTodayVsAverageLive do
  ...
  defp get_plot do
    ...
    average = case previous_week do
      [] -> 0
      _  -> Enum.reduce(previous_week, 0, fn x, acc -> acc + x[:usage_gas_meter] end) / Enum.count(previous_week)
    end
    ...
    Contex.Plot.new(ds, Contex.BarChart, 400, 200, title: "Gas", colour_palette: ["645ad3"])
    |> Contex.Plot.to_svg()
  end
